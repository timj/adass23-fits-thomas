...
other FITS files. Finally, the 2880 record is a minor but annoying restriction which results
...
% Juande Santander-Vela: The justification for the last statement 
% is that blocks must be ready while writing data, and hence either
% the FITS size balloons, or they cannot be properly written in
% real time, but converted from other format at a later stage.
