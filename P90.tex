...
Miguel~de~Val-Borro$^9$, Juande~Santander-Vela$^{10,11}$,
David~Shupe$^{12}$, John~Good$^{12}$, and G.~Bruce~Berriman$^{12}$
...
\affil{$^{11}$Square Kilometre Array Organisation, Jodrell Bank Observatory, 
  Lower Withington SK11~9DL, United Kingdom}
\affil{$^{12}$Infrared Processing and Analysis Center, Caltech,
